with stage_data as 
    (
        select distinct
            ...
            -- , case
            --     when contains_substr(sales_recouped_dollars, "-") then 0.0
...
-- next problem: recognizing/eliminating the - in sales_recouped_dollars
-- after this, data should be OK to just plot it